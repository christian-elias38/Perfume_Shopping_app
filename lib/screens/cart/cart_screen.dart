        ...
        child: cartState.items.isEmpty
            ? Center(
                child: Column(
                  ...
                  children: [
                    const Icon(Icons.shopping_bag_outlined, size: 72, color: AppColors.accentGold),
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return _CartItemTile(
                          item: item,
                          product: product,
                          onIncrement: () => cartNotifier.updateQuantity(item.id, item.quantity + 1),
                          onDecrement: () => cartNotifier.updateQuantity(item.id, item.quantity - 1),
                        );
                      },
                    ),
                  ),
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.product?.brand.toUpperCase() ?? 'LUXURY',
                      style: const TextStyle(
                        fontSize: 10,
                        fontWeight: FontWeight.bold,
